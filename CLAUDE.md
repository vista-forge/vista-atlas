...
**Vista Atlas** — a VSCode extension over the **vdocs gold-corpus data release**
(what the VA documentation *says*): faceted library, FTS5 search, reading pane
with table/figure/boilerplate hydration, entity pages. Twin of
`~/vista-forge/vista-compass` (the measured model); they cross-link via the
vdocs↔vista-meta entity bridge. **Governing design:**
